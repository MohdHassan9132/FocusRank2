...
export default function MiddleSection() {
  const features = [
    ...
    {
      title: "Pomodoro & To-Do List with Rankings",
      subtitle: "Lock Your Focus",
      description:
        "Stay productive using Pomodoro sessions and a to-do list, while your focus time is automatically tracked and reflected in rankings..",
      points: [
        "Pomodoro timer for deep focus",
        "To-do list for task management",
        "Earn ranking points from your session minutes",
      ],
      image: network,
    },
  ...
  return (
    <div>
      <div id="features" className="py-20 bg-white dark:bg-black overflow-hidden">
